  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="relative flex items-center space-x-3 p-3 rounded-2xl transition-all duration-300 bg-black/10 backdrop-blur-xl border border-white/10 hover:bg-black/20"
      >
        <Avatar className="w-8 h-8 ring-2 ring-white/20">
          ...
          />
          <AvatarFallback className="bg-gradient-to-r from-slate-600 to-slate-700 text-white text-sm font-medium">
            {userInitials}
          </AvatarFallback>
        </Avatar>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-16 w-80 max-h-[85vh] z-50"
            >
              <div className="bg-black/40 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-full">
                {/* User Info Header */}
                  ...
                  <div className="p-3 space-y-1">
                    ...
                    <div className="border border-white/10 rounded-2xl overflow-hidden">
                      <motion.button
                        ...
                        className="w-full flex items-center justify-between p-4 text-white/90 transition-all duration-200"
                      >
                        ...
                        {expandedTab === 'subscription' && (
                          ...
                          >
                            <div className="px-4 pb-4 space-y-3 border-t border-white/10">
                              {/* Quick Plan Overview */}
                              <div className="text-xs text-white/60 mb-3">Choose your plan:</div>
                              
                              {/* Monthly Plan */}
                              <button 
                                onClick={() => openSubscriptionModal('monthly')}
                                className="w-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/20 rounded-xl p-3 text-left hover:from-blue-500/30 hover:to-purple-500/30 transition-all duration-200"
                              >
                                <div className="flex justify-between items-center">
                                  <div>
                                    <div className="text-sm font-semibold text-white">Monthly Plan</div>
                                    <div className="text-xs text-white/60">7-day free trial</div>
                                  </div>
                                  <div className="text-right">
                                    <div className="text-sm font-bold text-blue-300">₹50</div>
                              ...
                              <button 
                                ...
                                className="w-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-400/20 rounded-xl p-3 text-left hover:from-emerald-500/30 hover:to-teal-500/30 transition-all duration-200"
                              >
                                <div className="flex justify-between items-center">
                                  <div>
                                    <div className="text-sm font-semibold text-white">Annual Plan</div>
                                    <div className="text-xs text-white/60">First month free</div>
                                  </div>
                                  <div className="text-right">
                                    <div className="text-sm font-bold text-emerald-300">₹199</div>
                              ...
                              <button 
                                ...
                                className="w-full bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-400/20 rounded-xl p-3 text-left hover:from-amber-500/30 hover:to-orange-500/30 transition-all duration-200"
                              >
                                <div className="flex justify-between items-center">
                                  <div>
                                  ...
                                  <div className="text-right">
                                    <div className="text-sm font-bold text-amber-300">Custom</div>
                ...
                <div className="flex-shrink-0 border-t border-white/10">
                  <div className="p-3">
                    <motion.button
                      ...
                      className="w-full flex items-center space-x-3 px-3 py-3 text-sm text-red-400 hover:text-red-300 rounded-2xl transition-all duration-200"
                    >
...
function TabMenuItem({ 
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-white/70 hover:text-white/90 rounded-xl transition-all duration-200"
    >
