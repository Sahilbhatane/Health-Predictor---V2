...
import { ParkinsonsPredictionForm } from "@/components/forms/parkinsons-prediction-form"
        ...
        >
          <div className="w-full max-w-[90%] xl:max-w-[85%] 2xl:max-w-[80%] mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              >
                Early detection of Parkinson's disease symptoms through advanced neurological pattern analysis.
                Switch between patient motor assessments and detailed vocal biomarker measurements.
              </motion.p>
            </div>
