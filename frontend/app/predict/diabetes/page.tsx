...
import { DiabetesPredictionForm } from "@/components/forms/diabetes-prediction-form"
        ...
        >
          <div className="w-full max-w-[90%] xl:max-w-[85%] 2xl:max-w-[80%] mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              >
                Assess your diabetes risk with comprehensive health metrics analysis using machine learning algorithms.
                Toggle between simple questions and detailed clinical parameters.
              </motion.p>
            </div>
